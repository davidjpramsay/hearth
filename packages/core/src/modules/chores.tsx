...
const DEFAULT_CONFIG = choresModuleConfigSchema.parse({});
...
const normalizeConfig = (config: unknown): ChoresModuleConfig => {
  const parsed = choresModuleConfigSchema.safeParse(config);
...
export const choresModule: ModuleDefinition<ChoresModuleConfig> = {
  id: "chores",
  displayName: "Chores",
  defaultSize: { w: 6, h: 4 },
  configSchema: choresModuleConfigSchema,
                  ...
                  >
                    <header className="flex items-center justify-between border-b border-slate-700 px-2 py-1.5">
                      ...
                      <div className="flex items-center gap-2 text-[11px] text-slate-300">
                        ...
                        {normalizedConfig.enableMoneyTracking ? (
                        ...
                        {normalizedConfig.enableMoneyTracking && member.bonusPayout > 0 ? (
                      ...
                      {memberItems.length > 0 ? (
                        memberItems.map((item) => (
                          ...
                          >
                            ...
                            {normalizedConfig.enableMoneyTracking && item.valueAmount !== null ? (
    ...
    return (
      <div className="space-y-4 rounded-lg border border-slate-700 bg-slate-900 p-4 text-sm text-slate-200">
        ...
        <label className="flex items-center justify-between">
          ...
          <input
            type="checkbox"
            checked={normalizedConfig.enableMoneyTracking}
